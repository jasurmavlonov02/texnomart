...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('positive_message', models.CharField(blank=True, max_length=255, null=True)),
                ('negative_message', models.CharField(blank=True, max_length=255, null=True)),
                ('message', models.CharField(max_length=255)),
                ('file', models.FileField(blank=True, null=True, upload_to='file/')),
                ('rating', models.IntegerField(choices=[(0, 'Nol'), (1, 'Bir'), (2, 'Ikki'), (3, 'Uch'), (4, 'Tort'), (5, 'Besh')], default=0)),
